...
/* Esta funcion se utiliza para obtener el numero de pacientes que ingresaron al hospital en cada una de las categorías de condicion. */
{
...
/* La funcion F3 se utiliza para generar el nombre y telefono de todos los pacientes que tuvieron una condicion de ingreso de máxima gravedad (5). */ 
{
int I;
