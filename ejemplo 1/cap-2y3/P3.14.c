...
#include <stdlib.h>
#include <stdio.h>
/* Elección. El programa obtiene el total de votos de cada
 candidato y el porcentaje➥correspondiente. También considera votos nulos.
  VOT, C1, C2, C3, C4, C5, NU, SVO: variables de tipo entero.PO1, PO2, PO3, PO4, PO5, PON: variables de tipo real.*/
void main(void)
{
