...
#include <math.h>
/* Suma cuadrados.El programa, al recibir como datos
n grupo de enteros positivos, obtiene el➥cuadrado de los mismos
 y la suma correspondiente a dichos cuadrados. */
void main(void)
{
    int NUM;
    long CUA, SUC = 0;
